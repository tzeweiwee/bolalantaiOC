      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-account" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-pop"><span class="required">*</span> Coupon Pop code</label>
            <div class="col-sm-10">
              <textarea name="couponpop" cols="100" rows="10" ><?php echo $couponpop; ?></textarea>
            </div>
          </div>
        </form>
