            ...
            <div id="product">
              ...
              <div class="product-buttons-wrap">
                ...
                <div class="cart pull-left space-right-15">
                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn">
                      <span><i class="fa fa-shopping-cart"></i><?php echo $button_cart; ?></span>
                    </button>
                </div> 
                <div class="pull-left space-right-5">  
                    <a data-toggle="tooltip" class="btn btn-sm btn-inverse-light" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><i class="zmdi zmdi-favorite zmdi-hc-fw"></i></a>
                </div>
                <div class="pull-left">
                    <a data-toggle="tooltip" class="btn btn-sm btn-inverse-light" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><i class="zmdi zmdi-tune zmdi-hc-fw"></i></a>
                </div>
              </div>  
              <?php if ($minimum > 1) { ?>
