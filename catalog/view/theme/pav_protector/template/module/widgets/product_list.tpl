...
<div class="panel bg-carousel panel-default">
	...
	<div class="list box-products owl-carousel-play <?php echo $addition_cls;?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>" id="product_list<?php echo $id;?>" data-ride="owlcarousel">
			...
			<div class="carousel-controls hidden-xs">
				<a class="carousel-control left" href="#product_list<?php echo $id;?>"   data-slide="prev"><i class="fa fa-angle-left zmdi-hc-fw"></i></a>
				<a class="carousel-control right" href="#product_list<?php echo $id;?>"  data-slide="next"><i class="fa fa-angle-right zmdi-hc-fw"></i></a>
			</div>
		<?php } ?>
