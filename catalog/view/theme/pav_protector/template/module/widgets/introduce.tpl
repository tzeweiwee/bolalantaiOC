<div class="widget">
    ...
    <div class="widget-inner introduce <?php echo $addition_cls;?> <?php if (isset($stylecls)&&$stylecls){echo "block-".$stylecls;}?>">
        <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 content-introduce pull-<?php if($position == 'left'){ echo 'right';}?>">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 text-center media-introduce pull-<?php if($position == 'left'){ echo 'left';}?>">
