			...
			<div class="panel-body">
				<div class="description space-20 space-padding-t5"><?php echo html_entity_decode( $description );?></div> 
             	<div class="input-group">
                    <input type="text" placeholder="Your Email..." class="form-control email radius-6x" <?php if(!isset($customer_email)): ?> <?php endif; ?> size="18" name="email">
                    <div class="input-group-btn">
                        <button type="submit" name="submitNewsletter" class="btn icon-mail radius-6x"></button>
                    </div>
              	</div>
