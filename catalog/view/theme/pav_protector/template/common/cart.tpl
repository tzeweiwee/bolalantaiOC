    ...
    <div data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="dropdown-toggle">      
      <div class="cart-inner">
        <a href="">
          ...
          <span id="text-items"><?php echo $res[1]; ?></span>
          </span>
  ...
  <ul class="dropdown-menu pull-right">
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a href="<?php echo $cart; ?>"><span class="btn btn-primary"><?php echo $text_cart; ?></span></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $checkout; ?>"><span class="btn btn-primary"><?php echo $text_checkout; ?></span></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
