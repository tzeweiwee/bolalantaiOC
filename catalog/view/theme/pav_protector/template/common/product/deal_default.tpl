      ...
      <div class="image">
        ...
        <div class="bottom">
          ...
          <div class="action pull-left">           
            ...
            <div class="compare">     
              <button class="btn btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="<?php echo $objlang->get("button_compare"); ?>" onclick="compare.addcompare('<?php echo $product['product_id']; ?>');"><i class="zmdi zmdi-tune zmdi-hc-fw"></i></button> 
            </div>  
            <div class="wishlist">
