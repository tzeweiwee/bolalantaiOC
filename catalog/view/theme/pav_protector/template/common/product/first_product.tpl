      ...
      <div class="image">
        ...
        <div class="bottom">
          ...
          <div class="action">           
            ...
            <div class="wishlist">
              <button class="btn btn-sm radius-x btn-outline-light " type="button" data-toggle="tooltip" data-placement="top" title="<?php echo $objlang->get("button_wishlist"); ?>" onclick="wishlist.addwishlist('<?php echo $first_product['product_id']; ?>');"><i class="zmdi zmdi-favorite zmdi-hc-fw"></i></button> 
            </div> 
