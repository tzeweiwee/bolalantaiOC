  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="space-padding-0"><?php echo $content_top; ?>
      ...
      <div class="contact-location hidden-xs space-20">
	        <div id="contact-map" style="height:400px;">
...
<?php endif; ?></div>
    ...
    <script type="text/javascript">
        var lat = <?php echo isset($themeConfig['location_latitude'])?$themeConfig['location_latitude']:'3.046386'; ?>;
        var lon = <?php echo isset($themeConfig['location_longitude'])?$themeConfig['location_longitude']:'101.623286'; ?>;
        function initMap() {
    		var uluru = {lat: 3.046386, lng: 101.623286};
    ...
    <script async defer
 src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAXPg4-1U2pD1_GFP_OGzVDKoMt4rJLBHM&callback=initMap"
